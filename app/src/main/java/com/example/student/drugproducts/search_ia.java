...
public class search_ia extends ActionBarActivity {

    AutoCompleteTextView actv;
    MyDBHandler DbHelper;
    Context context;
    String dbName = "drug_ia.db";
    Drug drug;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_ia);
        context = this;
        ...
        actv = (AutoCompleteTextView) findViewById(R.id.auto_name_ia);
        ...
        actv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                categorization = (TextView) findViewById(R.id.cateName_ia) ;
                classNames = (TextView) findViewById(R.id.className_ia) ;
                drug_id = (TextView) findViewById(R.id.drugIdName_ia) ;
                pediatric = (TextView) findViewById(R.id.pediatricName_ia) ;
                ais = (TextView) findViewById(R.id.aisName_ia) ;
                comp_names = (TextView)findViewById(R.id.comp_name_ia);
                address = (TextView) findViewById(R.id.addressName_ia) ;
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        ...
        menu.add(0, v.getId(), 0, "Search drug's detail online");
    }
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        }else if(item.getTitle() == "Search drug's detail online"){
